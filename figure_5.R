...
for(suffix in c("density_pct80", "strength_pct80")) { ##can change suffix to visualize other percentiles
  ...
  shared_regions_children <- aba_region_labels[which(aba_region_labels$parent_id %in% shared_regions[missing_rgn_indices]),"structure ID"]

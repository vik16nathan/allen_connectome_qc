...
write.csv(knox_conn_old_bilateral, "../derivatives/regionalized_connectomes/knox_conn_strength_old_bilateral.csv")
...
write.csv(knox_conn_new_bilateral, "../derivatives/regionalized_connectomes/knox_conn_strength_new_bilateral_1018.csv")

...
TOP_DIR='../mouse_connectivity_models/paper/'
FILE_DIR = "../mouse_connectivity_models/paper/figures/model_comparison/"
OUTPUT_DIR = os.path.join(FILE_DIR, 'output')
INPUT_JSON = os.path.join(TOP_DIR, 'input.json')

#####CHANGE THIS LINE!!!####
EXPERIMENTS_EXCLUDE_JSON = os.path.join(TOP_DIR, 'experiments_exclude_updated.json')
############################

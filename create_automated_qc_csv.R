...
mask <- "/data/chamal/projects/yohan/common/allenbrain/data/mouse_atlas/ccfv3/mask_50um.mnc"
maskVol <- mincGetVolume(mask)

#load the dictionary from label numbers <-- --> region acronyms
aba_region_labels <- as.data.frame(read_csv(paste0(allen_input_dir, "AMBA_relabeled_defs_byname.csv")))
...
mincWriteVolume(vent_volume, "/data/chamal/projects/natvik/knox_qc_full_06232025/preprocessed/allen_template_inputs/vent_voxels_label_file_50um.mnc",
...
mincWriteVolume(vent_volume, "/data/chamal/projects/natvik/knox_qc_full_06232025/preprocessed/allen_template_inputs/vent_voxels_label_file_50um_filt.mnc",
                like=aba_label_filepath)
...
knox_experiments_orig_excluded <- as.data.frame(read.csv("../derivatives/knox_excluded_original/knox_excluded_tracers.csv"))
...
tracer_dir_orig_removed <- "/data/chamal/projects/natvik/knox_qc_full_06232025/preprocessed/knox_connectome_tracers/orig_removed/"
...
colnames(tracer_oob_vent_prop_df_orig_removed) <- c("tracer", "proj_num_vox", "proj_vox_oob", "proj_vox_vent", 
                                       "inj_num_vox", "inj_vox_oob", "inj_vox_vent")
#write.csv(tracer_oob_vent_prop_df, paste0("tracer_oob_vent_prop_df_50um_proj_bin",thresh,"_morph.csv"))
write.csv(tracer_oob_vent_prop_df, paste0("tables/knox_oob_vent_df_inj",inj_thresh,"_proj",proj_thresh,"_1018.csv"))

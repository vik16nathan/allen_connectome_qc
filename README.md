...
* Note: I also modified get_regional_data() in model_data.py (https://github.com/AllenInstitute/mouse_connectivity_models/tree/master/paper/figures/model_comparison/helpers) to include the 211 Oh connectome regions, rather than the 291 regions defined in Knox et al. This choice enables direct comparison/downstream application of the rebuilt homogeneous model in place of the Oh connectome.

...
python ../../allen_connectome_qc/transform_space.py "average_template_50.nrrd" "average_template_50.mnc"  -v RAS -w MICe -x 1
...
python ../../allen_connectome_qc/transform_space.py "annotations_25.nrrd" "annotations_25.mnc" -v RAS -w MICe -x 1 --volume_type uint

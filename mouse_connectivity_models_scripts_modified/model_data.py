...
class ModelData(object):
    ...
    def get_regional_data(self, high_res=False, threshold_injection=True, **kwargs):
        def get_summary_structure_ids(): ###toggle/change this to be consistent with Oh et al., 2014
            ...
            structures_dir="/data/chamal/projects/natvik/SIR_rerun_ohbm_11272025/derivatives/rahayel_oh_conn_rgn_numbers/"
            structures = pd.read_csv(structures_dir+"rgn_list.txt", header=None).loc[:,0]
            return structures
